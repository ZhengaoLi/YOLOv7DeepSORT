...
if __name__ == "__main__":
    ...
    #--------------------------------------------------------------------------------------#
    classes_path    = 'model_data/bac_classes.txt'
    #--------------------------------------------------------------------------------------#
    ...
    #   结果输出的文件夹，默认为map_out
    #-------------------------------------------------------#
    map_out_path    = 'test_result'

    image_ids = open( "dataset/test.txt").read().strip().split()
    ...
    if map_mode == 0 or map_mode == 1:
        ...
        for image_id in tqdm(image_ids):
            image_path  = "dataset/test/"+image_id+".jpg"
            # print(image_path)
