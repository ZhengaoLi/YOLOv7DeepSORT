...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    video_path      = 'vdo.avi'
    video_save_path = "vdo_result_new.avi"
    video_fps       = 25.0
    #----------------------------------------------------------------------------------------------------------#
    ...
    #-------------------------------------------------------------------------#
    # dir_origin_path = 'C:/Users/zl23i/Desktop/MaLab/02YOLOv7Pytorch/voc/VOC2007/JPEGImages'
    # dir_origin_path = 'C:/Users/zl23i/Desktop/MaLab/02YOLOv7Pytorch/vocdevkit/VOC2007/JPEGImages'
    dir_save_path = f'ResultWithoutFooddebris/predictresult_{confidence}'
    dir_origin_path = f'dataset_withoutdebris/testall'
    # dir_save_path   = 'C:/Users/zl23i/Desktop/MaLab/02YOLOv7Pytorch/bacteriaresult'
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        while True:
            ...
            # 调用检测模型并获取结果
            output = yolo.detect_image(frame)

            # 提取图像（元组的第一个元素）
            detected_frame = output[0]

            # 如果是 PIL.Image，转换为 NumPy 数组
            if isinstance(detected_frame, Image.Image):
            ...
            # RGB to BGR 转换，满足 OpenCV 显示格式
            frame = cv2.cvtColor(detected_frame, cv2.COLOR_RGB2BGR)
        ...
        for img_name in tqdm(img_names):
            if img_name.lower().endswith(('.bmp', '.dib', '.png', '.jpg', '.jpeg', '.pbm', '.pgm', '.ppm', '.tif', '.tiff')):
                ...
                r_image     = yolo.detect_image(image, imagename=img_name)
